...
```{r echo=FALSE, fig.cap = "<b>Figure.1 Class imbalance. There is an imbalance between the two prediction classes</b>", fig.align="center", out.width='40%',out.height='10%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.2 Density plots of numerical features by target class. Overlapping distribution among features for the two classes</b>", fig.align="center", out.width='70%',out.height='70%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.3 Confusion Matrix before Feature Selection. High number of false positive results</b>", out.width='50%',out.height='40%'}
...
cr <- cr %>% select(-X1)
colnames(cr)[1]="Class"
knitr::kable(cr, caption = "**Table 3: Classification report of the best model before applying feature selection. High accuracy but low f1 and recalling score for the positive class**")
```
...
```{r echo=FALSE, fig.cap = "<b>Figure.4 Confusion Matrix after Feature Selection. Higher number of false negatives</b>", out.width='50%',out.height='40%'}
