...
```{r echo=FALSE, fig.cap = "<b>Figure.1 Class imbalance. There is an imbalance between the two prediction classes</b>", fig.align="center", out.width='100%',out.height='10%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.2 Density plots of numerical features by target class. Overlapping distribution among features for the two classes</b>", fig.align="center", out.width='100%',out.height='100%'}
