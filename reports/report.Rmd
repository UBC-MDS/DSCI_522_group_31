...
Among those features, there are some features that might be important to predict the target: 'ProductRelated\_Duration', 'BounceRates', 'ExitRates', 'PageValues', 'Month', 'TrafficType' and 'VisitorType'.
...
```{r echo=FALSE, fig.cap = "<b>Figure.1 Density plots of numerical features by target class</b>", out.width='80%',out.height='70%'}
...
cr <- cr %>% select(-X1)
colnames(cr)[1]="Class"
knitr::kable(cr, caption = "**Table 4: Classification report of the best model after applying feature selection**")
```
