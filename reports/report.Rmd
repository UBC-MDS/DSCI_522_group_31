...
```{r echo=FALSE, fig.cap = "<b>Figure.1 Class imbalance</b>", fig.align="center", out.width='40%',out.height='10%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.2 Density plots of numerical features by target class</b>", fig.align="center", out.width='70%',out.height='70%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.3 Confusion Matrix before Feature Selection</b>", out.width='50%',out.height='40%'}
...
```{r echo=FALSE, fig.cap = "<b>Figure.4 Confusion Matrix after Feature Selection</b>", out.width='50%',out.height='40%'}
