...
```{r echo=FALSE, fig.cap = "**Figure.2 Confusion Matrix before Feature Selection**", out.width='80%',out.height='70%'}
...
```{r echo=FALSE, fig.cap = "**Figure.3 Confusion Matrix after Feature Selection**", out.width='80%',out.height='70%'}
