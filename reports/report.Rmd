...
Prior to fitting the model, we looked at how the distribution of each of the features in the training set varies between the two classes (revenue generator: blue, not a revenue generator: orange). This visualization shows us overlap in the distribution of features across the two target classes, although their spreads and means differ in some cases. As a result, we opted to include all features in the initial analysis and subsequently try to use RFE to better guide us at feature selection.
